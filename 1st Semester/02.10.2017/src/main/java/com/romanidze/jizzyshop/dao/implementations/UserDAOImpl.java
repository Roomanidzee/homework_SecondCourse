package com.romanidze.jizzyshop.dao.implementations;
...
public class UserDAOImpl implements UserDAOInterface{
    ...
    private static final String INSERT_QUERY = "INSERT INTO users (username_or_email, password) VALUES (?, ?)";
    private static final String FIND_QUERY = "SELECT FROM users WHERE users.id = ?";
    private static final String FIND_ALL_QUERY = "SELECT * from users";
    private static final String DELETE_QUERY = "DELETE FROM users WHERE users.id = ?";
    private static final String UPDATE_QUERY = "UPDATE users SET(username_or_email, password) = (?, ?) " +
                                                "WHERE users.id = ?";
    private static final String FIND_BY_USERNAME_QUERY = "SELECT FROM users WHERE users.username_or_email = ?";
