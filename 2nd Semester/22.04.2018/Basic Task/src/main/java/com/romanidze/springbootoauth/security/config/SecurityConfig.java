package com.romanidze.springbootoauth.security.config;

import com.romanidze.springbootoauth.security.utils.ClientResources;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private Filter ssoFilter(){
        ...
        UserInfoTokenServices tokenServices =
                new UserInfoTokenServices(github().getResource().getUserInfoUri(), github().getClient().getId());
