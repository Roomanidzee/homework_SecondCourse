...
public class ProductServiceImpl implements ProductServiceInterface {
    ...
    @Autowired
    public ProductServiceImpl(ProductDAOInterface productDAO, UserDAOInterface userDAO) {
    ...
    @Override
    public List<Product> getProductsByUserQuery(String userRequest) {
        return this.productDAO.findAllByTitle(userRequest);
    }
}
